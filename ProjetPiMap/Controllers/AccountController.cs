    ...
    public class AccountController : Controller
    {
       ...
       //     string id = UserManager.FindByEmail(model.Email).Id;
            ...
            if (user.EmailConfirmed == true)
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        if (user is Resource) return RedirectToAction("Index", "Client");
                        if(user is Admin)  return RedirectToAction("Index", "Test");
                        else return RedirectToAction("Index", "Client");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                if (model.RoleName.Equals("Resource")) {
               ...
               //  UserManager.AddToRoleAsync(user.Id,model)   
                    ...
                    user = new Admin { UserName = model.Email, Email = model.Email, firstname = model.firstname, lastname = model.lastname, address = model.address, PhoneNumber = model.phoneNumber, motDePasse = model.Password };
        ...
        [AllowAnonymous]
        public ActionResult ConfEmail2()
        {
            return View();
        }

        [AllowAnonymous]
        public ActionResult AccountComplete()
        {
            return View();
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(RegisterViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new Resource { UserName = model.Email, Email = model.Email, firstname = model.firstname, lastname = model.lastname, address = model.address, PhoneNumber = model.phoneNumber, motDePasse = model.Password };
